...
int main(int argc, char* argv[]) {
  ...
  // find vertices
  TestSeedFinderAlgorithm::Config findVertices(magneticField);
  ...
  sequencer.addAlgorithm(std::make_shared<TestSeedFinderAlgorithm>(
  ...
  RootSeedVertexPerformanceWriter::Config vertexWriterConfig;
  ...
  sequencer.addWriter(std::make_shared<RootSeedVertexPerformanceWriter>(
