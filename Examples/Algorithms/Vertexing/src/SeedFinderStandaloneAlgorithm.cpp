...
#include "ActsExamples/Vertexing/SeedFinderStandaloneAlgorithm.hpp"
...
ActsExamples::SeedFinderStandaloneAlgorithm::
    SeedFinderStandaloneAlgorithm(const Config& cfg,
                                       Acts::Logging::Level lvl)
    : ActsExamples::BareAlgorithm("VertexSeedFinder", lvl),
      m_cfg(cfg) {
...
ActsExamples::SeedFinderStandaloneAlgorithm::execute(
